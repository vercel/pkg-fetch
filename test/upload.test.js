...
test(async (t) => {
  ...
  const mustBe = [
    ...
    'patch -p1 -i ../patches/node.v0.12.15.patch {"cwd":"../precompile/node"}',
    '> Compiling Node.js from sources...',
    './configure --dest-cpu ia32 {"cwd":"../precompile/node"}',
    'make  {"cwd":"../precompile/node"}',
    'copyFile ../precompile/node/out/Release/node v1337.2/built-v0.12.15-macos-x86',
    ...
    './configure --dest-cpu ia32 {"cwd":"../precompile/node"}',
    'make  {"cwd":"../precompile/node"}',
    'copyFile ../precompile/node/out/Release/node v1337.2/built-v4.4.7-macos-x86',
    ...
    'patch -p1 -i ../patches/node.v6.3.1.patch {"cwd":"../precompile/node"}',
    '> Compiling Node.js from sources...',
    './configure --dest-cpu ia32 --without-inspector {"cwd":"../precompile/node"}',
    'make  {"cwd":"../precompile/node"}',
    'copyFile ../precompile/node/out/Release/node v1337.2/built-v6.3.1-macos-x86',
