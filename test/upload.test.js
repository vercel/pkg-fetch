...
test(async (t) => {
  ...
  const mustBe = [
    ...
    'git clone --bare --progress https://github.com/nodejs/node node/.git {"cwd":"../lib/build"}',
    '> Checking out v0.12.15',
    'git --work-tree . reset --hard v0.12.15 {"cwd":"../lib/build/node"}',
    '> Applying patches',
    'patch -p1 -i ../patches/backport.R00000.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24002.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24204.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24262.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24266.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24523.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24543.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24639.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24642.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24643.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24644.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R24824.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R25039.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/backport.R25444.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/node.v0.12.15.patch {"cwd":"../lib/build/node"}',
    '> Compiling Node.js from sources...',
    './configure --dest-cpu x64 {"cwd":"../lib/build/node"}',
    'make  {"cwd":"../lib/build/node"}',
    'copyFile ../lib/build/node/out/Release/node v1337.2/built-v0.12.15-macos-x64',
    ...
    'patch -p1 -i ../patches/node.v0.12.15.patch {"cwd":"../lib/build/node"}',
    '> Compiling Node.js from sources...',
    './configure --dest-cpu ia32 {"cwd":"../lib/build/node"}',
    'make  {"cwd":"../lib/build/node"}',
    'copyFile ../lib/build/node/out/Release/node v1337.2/built-v0.12.15-macos-x86',
    ...
    'git clone --bare --progress https://github.com/nodejs/node node/.git {"cwd":"../lib/build"}',
    '> Checking out v4.4.7',
    'git --work-tree . reset --hard v4.4.7 {"cwd":"../lib/build/node"}',
    '> Applying patches',
    'patch -p1 -i ../patches/backport.R32768.v8=4.5.patch {"cwd":"../lib/build/node"}',
    'patch -p1 -i ../patches/node.v4.4.7.patch {"cwd":"../lib/build/node"}',
    '> Compiling Node.js from sources...',
    './configure --dest-cpu x64 {"cwd":"../lib/build/node"}',
    'make  {"cwd":"../lib/build/node"}',
    'copyFile ../lib/build/node/out/Release/node v1337.2/built-v4.4.7-macos-x64',
    ...
    './configure --dest-cpu ia32 {"cwd":"../lib/build/node"}',
    'make  {"cwd":"../lib/build/node"}',
    'copyFile ../lib/build/node/out/Release/node v1337.2/built-v4.4.7-macos-x86',
    ...
    'git clone --bare --progress https://github.com/nodejs/node node/.git {"cwd":"../lib/build"}',
    '> Checking out v6.3.1',
    'git --work-tree . reset --hard v6.3.1 {"cwd":"../lib/build/node"}',
    '> Applying patches',
    'patch -p1 -i ../patches/node.v6.3.1.patch {"cwd":"../lib/build/node"}',
    '> Compiling Node.js from sources...',
    './configure --dest-cpu x64 --without-inspector {"cwd":"../lib/build/node"}',
    'make  {"cwd":"../lib/build/node"}',
    'copyFile ../lib/build/node/out/Release/node v1337.2/built-v6.3.1-macos-x64',
    ...
    'patch -p1 -i ../patches/node.v6.3.1.patch {"cwd":"../lib/build/node"}',
    '> Compiling Node.js from sources...',
    './configure --dest-cpu ia32 --without-inspector {"cwd":"../lib/build/node"}',
    'make  {"cwd":"../lib/build/node"}',
    'copyFile ../lib/build/node/out/Release/node v1337.2/built-v6.3.1-macos-x86',
